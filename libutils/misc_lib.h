...
/**
 * STATIC_ASSERT(e, m)
 * @brief Asserts a condition at compile time.
 * @param e Expression to assert.
 * @param m Message to print on failure. This is currently unused and is only
 *          here for future compatibility with C++11.
 *
 * Taken from here:
